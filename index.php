...
<html>
    <head>
        <meta charset="UTF-8">
        <title>proyecto Final Investigación de operaciones</title>
    </head>
    <style>
        body{
    ...
    <body>        
        <div class="container">
            <div id="seleccionar_metodo" class="jumbotron">
                <center><h2>Proyecto Investigación de operaciones</h2><br>
                <h2>CARLOS DANIEL LÓPEZ HERNÁNGDEZ</h2><br>
                <h2>5190-19-5203</h2></center>
                <center><a onclick="display_simplex()" class="btn btn-lg btn-success" role="button">Simplex</a>
                <a onclick="display_hungaro()" class="btn btn-lg btn-success" role="button">Húngaro</a></center>
            </div>
